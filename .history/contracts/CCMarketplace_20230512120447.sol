...
contract CCMarketplace {
    ...
    mapping(uint256 => address payable) private charityidToAddress;
    ...
    function addCharity(address payable _charityAddress) { 
        require(owner == msg.sender, "Only owner can update available charities");
        charityID++; 
        charityidToAddress[charityID] = _charityAddress
